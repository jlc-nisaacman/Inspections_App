...
class PumpSystemsTablePageState extends State<PumpSystemsTablePage> {
  ...
  Future<void> _checkConnectivityAndData() async {
    ...
    if (status != ConnectionStatus.connected) {
      final count = await _dataService.getPumpSystemsCount();
      setState(() {
  ...
  void _navigateToDetailView(PumpSystemData pumpSystemData) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PumpSystemDetailView(pumpSystemData: pumpSystemData),
      ),
    );
  }
  ...
  void _showConnectionHelp() {
    ...
    if (_connectionStatus == ConnectionStatus.noNetwork) {
      ...
      message = 'Your device has internet, but the pump system server is unreachable.';
      actions = [
