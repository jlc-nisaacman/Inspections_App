        ...
        child: Column(
          ...
          children: [
            ...
            if (backflowType == 'DCVA') ...[
              ...
              _buildInfoRow('Back Pressure Test 1 PSI', form.dcvaBackPressureTest1PSI?.toString() ?? 'N/A'),
              _buildInfoRow('Back Pressure Test 4 PSI', form.dcvaBackPressureTest4PSI?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 1 PSID', form.dcvaCheckValve1PSID?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 2 PSID', form.dcvaCheckValve2PSID?.toString() ?? 'N/A'),
              _buildInfoRow('Flow', form.dcvaFlow?.toString() ?? 'N/A'),
              _buildInfoRow('No Flow', form.dcvaNoFlow?.toString() ?? 'N/A'),
              const Divider(),
            ],
            ...
            if (backflowType == 'PVB' || backflowType == 'SRVB') ...[
              ...
              _buildInfoRow('Air Inlet Valve Did Not Open', form.pvbSrvbAirInletValveDidNotOpen?.toString() ?? 'N/A'),
              _buildInfoRow('Air Inlet Valve Opened At PSID', form.pvbSrvbAirInletValveOpenedAtPSID?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve Flow', form.pvbSrvbCheckValveFlow),
              _buildInfoRow('Check Valve PSID', form.pvbSrvbCheckValvePSID?.toString() ?? 'N/A'),
              const Divider(),
            ],
            ...
            if (backflowType == 'RPZ') ...[
              ...
              _buildInfoRow('Check Valve 1 Closed Tight', form.rpzCheckValve1ClosedTight?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 1 Leaked', form.rpzCheckValve1Leaked?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 1 PSID', form.rpzCheckValve1PSID?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 2 Closed Tight', form.rpzCheckValve2ClosedTight?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 2 Leaked', form.rpzCheckValve2Leaked?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve 2 PSID', form.rpzCheckValve2PSID?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve Flow', form.rpzCheckValveFlow?.toString() ?? 'N/A'),
              _buildInfoRow('Check Valve No Flow', form.rpzCheckValveNoFlow?.toString() ?? 'N/A'),
              _buildInfoRow('Relief Valve Did Not Open', form.rpzReliefValveDidNotOpen?.toString() ?? 'N/A'),
              _buildInfoRow('Relief Valve Opened At PSID', form.rpzReliefValveOpenedAtPSID?.toString() ?? 'N/A'),
              const Divider(),
            ],
